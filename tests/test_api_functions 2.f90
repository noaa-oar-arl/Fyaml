...
contains
    ...
    subroutine test_fyaml_add_get_functions()
        ...
        call fyaml_get(yml, "real_var", result_real, RC)
        call assert_equal_int(fyaml_Success, RC, "fyaml_add_get: real_var added and retrieved")
        call assert_equal_real(3.14_yp, result_real, "fyaml_add_get: real_var value")
        
        ! Test adding and getting string variable
        call fyaml_add(yml, "string_var", "hello", "String variable", RC)
        call fyaml_get(yml, "string_var", result_str, RC)
        call assert_equal_int(fyaml_Success, RC, "fyaml_add_get: string_var added and retrieved")
        call assert_equal_string("hello", result_str, "fyaml_add_get: string_var value")
        
        ! Test adding and getting boolean variable
        call fyaml_add(yml, "bool_var", .true., "Boolean variable", RC)
        call fyaml_get(yml, "bool_var", result_log, RC)
        call assert_equal_int(fyaml_Success, RC, "fyaml_add_get: bool_var added and retrieved")
        call assert_equal_logical(.true., result_log, "fyaml_add_get: bool_var value")
